...
import ejemplouniversidad.modelo.*;
...
private Conexion conexion;
    ...
    public VistaCargaNotas() {
        ...
        listaCursada =(ArrayList)inscripcionData.obtenerInscripciones();
      ...
      public void borraFilasTabla(){
       ...
       public void cargaDatos(){
        ...
        listaCursada= (ArrayList)id.obtenerCursadasXAlumno(seleccionado.getId_alumno());
        
        for(Inscripcion m:listaCursada){
        
            modelo.addRow(new Object[]{m.getMateria().getIdMateria(),m.getMateria().getNombre(),m.getCalificacion()});
        }
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        if(filaSeleccionada!=-1){
            ...
            InscripcionData id=new InscripcionData(conexion);
            id.actualizarNotaCursada(a.getId_alumno(), idMateria,nota);
            borraFilasTabla();
