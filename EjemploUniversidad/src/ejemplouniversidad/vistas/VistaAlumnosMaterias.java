...
import ejemplouniversidad.modelo.InscripcionData;
import ejemplouniversidad.entidades.Materia;
import ejemplouniversidad.modelo.MateriaData;
...
private Conexion conexion;
     ...
     */
    public VistaAlumnosMaterias() throws ClassNotFoundException {
        initComponents();
 ...
 public void armaCabeceraTabla(){
      ...
      public void borraFilasTabla(){
        ...
        for(Inscripcion m:listaInscripcion){
            ...
            modelo.addRow(new Object[]{m.getAlumno().getId_alumno(),m.getAlumno().getNombre(),m.getCalificacion()});
            }           
        }
    }
