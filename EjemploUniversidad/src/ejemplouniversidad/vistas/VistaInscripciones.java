...
private Conexion conexion;
    ...
    private void btAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAnularActionPerformed
        ...
        if(filaSeleccionada!=-1){
            ...
            InscripcionData id=new InscripcionData(conexion);
            id.borrarCursadaDeUnaMateriaDeunAlumno(a.getId_alumno(), idMateria);
            borraFilasTabla();
  ...
  public void cargaDatosNoInscriptas(){
      ...
      borraFilasTabla();
          //Llenar filas
        InscripcionData cd =new InscripcionData(conexion);
        Alumno seleccionado=(Alumno)cbAlumnos.getSelectedItem();
        listaMaterias = (ArrayList)cd.obtenerMateriasNOCursadas(seleccionado.getId_alumno());
  ...
  public void cargaDatosInscriptas(){
        ...
        InscripcionData cd =new InscripcionData(conexion);
        Alumno seleccionado=(Alumno)cbAlumnos.getSelectedItem();
        listaMaterias = (ArrayList)cd.obtenerMateriasCursadas(seleccionado.getId_alumno());
